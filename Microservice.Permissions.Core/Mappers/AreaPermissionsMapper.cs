...
public class AreaPermissionsMapper :
    Mapper<AreaRolePermissionsEntity, AreaPermissionsResponse>,
    IAreaPermissionsMapper
{
    ...
    public override AreaPermissionsResponse Map(AreaRolePermissionsEntity source)
    {
        ...
        var result = new AreaPermissionsResponse
        {
            Id = source.Id,
